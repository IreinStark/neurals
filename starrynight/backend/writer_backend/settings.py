"""
Django settings for writer_backend project.
...
SECRET_KEY = "django-insecure-o+p)_g!fyx!5a@&i-#@&@x(urrex&nh!61kehyg)gi+-38x3ci"
...
ROOT_URLCONF = "writer_backend.urls"
...
WSGI_APPLICATION = "writer_backend.wsgi.application"
